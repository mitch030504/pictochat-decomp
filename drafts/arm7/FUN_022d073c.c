...
// verify:  python tools/match.py --c <file> --func FUN_022d073c --addr 0x022d073c --size 0x5c --module arm7 --version 2.0/sp1


undefined2 * FUN_022d073c(undefined2 *param_1,undefined2 param_2)
