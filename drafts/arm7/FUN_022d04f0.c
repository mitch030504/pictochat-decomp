...
// verify:  python tools/match.py --c <file> --func FUN_022d04f0 --addr 0x022d04f0 --size 0x5c --module arm7 --version 2.0/sp1


undefined2 * FUN_022d04f0(undefined2 *param_1,undefined2 param_2)
