...
// verify:  python tools/match.py --c <file> --func FUN_022c48e0 --addr 0x022c48e0 --size 0x34 --module arm7 --version 2.0/sp1


ulonglong FUN_022c48e0(undefined4 param_1)

{
  ...
  uVar2 = FUN_022c4854();
  uVar4 = *DAT_022c4910;
  puVar3 = (ushort *)(DAT_022c4910 + -3);
  *DAT_022c4910 = param_1;
  uVar1 = *puVar3;
  *puVar3 = uVar2;
