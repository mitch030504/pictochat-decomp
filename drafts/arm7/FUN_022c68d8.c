...
// verify:  python tools/match.py --c <file> --func FUN_022c68d8 --addr 0x022c68d8 --size 0x90 --module arm7 --version 2.0/sp1


void FUN_022c68d8(int *param_1,int param_2,undefined2 param_3,int param_4,int param_5)
