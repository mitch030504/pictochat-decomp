...
// verify:  python tools/match.py --c <file> --func FUN_022dbc00 --addr 0x022dbc00 --size 0x7c --module arm7 --version 2.0/sp1


bool FUN_022dbc00(ushort *param_1,undefined2 param_2)

{
  int *piVar1;
  int iVar2;
  
  iVar2 = func_0x037c58fc(*DAT_022dbc78 + 0x188,0x18);
  if (iVar2 != 0) {
    *(undefined2 *)(iVar2 + 0xc) = 0x85;
