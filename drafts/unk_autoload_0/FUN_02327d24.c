...
// verify:  python tools/match.py --c <file> --func FUN_02327d24 --addr 0x02327d24 --size 0x44 --module unk_autoload_0 --version 2.0/sp1
...

{
  ...
  if (iVar1 == 1) {
    uVar2 = FUN_023212f8();
    uVar3 = FUN_02321304();
    iVar1 = FUN_0232e004(DAT_02327d64,uVar2,uVar3);
    if (iVar1 == 4) {
      FUN_02320978(0xf);
    }
  }
