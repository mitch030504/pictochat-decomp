...
// NONMATCHING: closest known draft for this function. At mwccarm 2.0/sp2p2 it is
// SIZE EXACT (0x1194) with 0 bad relocations and 72 differing words of 1125.
// Counts as decompiled, not matched.
// flags: -O4,s -noThumb

// PROVENANCE AND WHAT IS / IS NOT VERIFIED - read before trusting this file.
//
// This source is PERMUTER-DERIVED, then cleaned by hand. What was verified:
//   - it compiles, and at 2.0/sp2p2 gives size 0x1194 exact, 72 differing
//     words, 0 bad relocations (1125 comparison rows, so a real comparison);
//   - the cleanup is codegen-neutral: naming 15 pool constants and renaming
//     five machine-generated helpers left the compiled output bit-identical,
//     re-measured after each step;
//   - the 64-bit high-word extraction and the 64-bit `| 1` are correct (see
//     the contamination warning below).
//
// What is NOT verified: this file differs from the hand-written draft by
// ~1300 lines that have NOT been reviewed line by line. Do not treat it as
// logic-proven. Three semantic corruptions were already found and fixed in one
// expression; others may remain elsewhere. Verify against the ROM before
// relying on any particular statement.
//
// It is parked here anyway because it is by far the best starting point: 72
// words versus 312 for the hand-written draft, at the ONLY build family that
// can match. The hand-written version remains in this PR's history (commit
// 0a6832c) if a fully-verifiable base is preferred.
//
// At canonical 2.0/sp1 this file is 0x1174 - far off - which does not matter,
// because sp1 cannot match this function at all (see below).
//
...
#define DAT_022cf740 0x00008002
...
#define DAT_022cf73c 0x02ffff98
#define DAT_022cf748 0x038071d8
#define DAT_022cf750 0x02302e54
#define DAT_022cf75c 0x03807204
#define DAT_022cf760 0x02302dc0
#define DAT_022cf764 0x048080f8
#define DAT_022cfa38 0x02302eec

inline int shl(int arg0, uint arg1)
{
  return arg0 << arg1;
}

inline int ptr_to_int(ushort *arg0)
{
  return (int) arg0;
}

inline int u64_lo32(undefined8 arg0)
{
  return (int) arg0;
}

inline int ptr_as_int(void *arg0)
{
  return ptr_to_int(arg0);
}

inline volatile ushort read_stride_volatile(ushort *arg0)
{
  return *((volatile ushort *) (arg0 + 3));
}
...
void FUN_022ce8b0(void)
{
  ...
  do
  {
    while (1)
    {
      ...
      uVar12 = *((ushort *) (ptr_to_int(msg) + 0xc));
      uVar1 = uVar12 & 0xff00;
      uVar2 = uVar12 & 0xff;
      uVar21 = uVar2;
      if (((uVar1 == 0) || (uVar1 == 0x100)) && ((uVar21 & 0x80) != 0))
      {
        break;
      }
      goto release;
    ...
    uVar15 = (uint) (*((volatile ushort *) (ptr_to_int(msg) + 0xc)));
    switch (u64_lo32(uVar15))
    {
      case 0x84:
      ...
      case 0x85:
      {
        ...
        {
          func_037cb8b4(ptr_to_int(msg) + 0x10, local_34, 6);
          found85 = 0;
          for (i85 = 0; i85 < 0xf; i85 = i85 + 1)
          {
            ...
            if (1)
            {
              ...
              {
                offset85 = i85 * 6;
                iVar16 = ((int) unaff_r8) + offset85;
                if ((((((local_34[0] == (*((byte *) ((ptr_to_int(unaff_r8) + offset85) + 0x128)))) && (local_34[1] == (*((byte *) ((ptr_to_int(unaff_r8) + offset85) + 0x129))))) && (local_34[2] == (*((byte *) ((ptr_to_int(unaff_r8) + offset85) + 0x12a))))) && (local_34[3] == (*((byte *) ((ptr_to_int(unaff_r8) + offset85) + 0x12b))))) && (local_34[4] == (*((byte *) ((ptr_to_int(unaff_r8) + offset85) + 0x12c))))) && (local_34[5] == (*((byte *) (iVar16 + 0x12d)))))
                {
          ...
          if (found85 != 0)
          {
            ...
            *puVar6 = 8;
            ...
            if ((*((int *) (unaff_r8 + 6))) == 1)
            {
              FUN_022d5870(shl(1, found85) & 0xffff);
            }
          }
        }
        else
      ...
      case 0x86:
        uVar12 = *((ushort *) (ptr_to_int(msg) + 0x16));
        uVar15 = (uint) uVar12;
        if ((uVar15 != 0) && (uVar15 < 0x10))
      {
        if (unaff_r8[0x7b] == 0)
        {
          ...
          else
          {
            in_r3 = (ushort *) 0x22;
            *puVar10 = 0x22;
            func_037cb8b4(ptr_to_int(msg) + 0x10, puVar10 + 1, 6);
        ...
        {
          uVar7 = func_037cb520();
          unaff_r8[0xc1] = unaff_r8[0xc1] | shl(1, uVar15);
          unaff_r8[0x43] = unaff_r8[0x43] & (~shl(1, uVar15));
          uVar24 = func_037caa3c();
          in_r3 = unaff_r8 + 0x94;
          *((ulonglong *) ((unaff_r8 + (uVar15 * 4)) + 0x39c)) = uVar24 | 1;
          iVar16 = uVar15 - 1;
          func_037cb8b4(ptr_to_int(msg) + 0x10, ((byte *) in_r3) + (iVar16 * 6), 6);
          func_037cb534(uVar7);
          in_r3 = unaff_r8 + 0xfc;
          ...
          *puVar6 = 8;
          ...
          func_037cb8b4(((int) msg) + 0x10, puVar6 + 5, 6);
          puVar6[8] = uVar12;
          func_037cb78c(ptr_to_int(msg) + 0x22, puVar6 + 10, 0x18);
          puVar6[0x16] = unaff_r8[0x18];
          puVar6[0x17] = unaff_r8[0x19];
          func_037d1464(puVar6);
        }
      ...
      case 0x8d:
        uVar15 = FUN_022cfa7c((uint) (*((byte *) (ptr_to_int(msg) + 0x1f))));
        uVar15 = uVar15 ^ shl((uint) (*((ushort *) DAT_022cf73c)), 1);
        *((ushort *) DAT_022cf73c) = uVar15 ^ (uVar15 >> 0x10);
        ...
        if ((*((int *) (unaff_r8 + 8))) != 0)
      {
        ...
        if ((iVar5 != 1) && ((*((ushort *) (ptr_to_int(msg) + 0x16))) <= DAT_022cf744))
        {
          unaff_r8[0x57] = unaff_r8[0x57] ^ 1;
          iVar5 = *((int *) ((unaff_r8 + (((uint) unaff_r8[0x57]) * 2)) + 0x58));
          func_037cb8b4(ptr_to_int(msg) + 0x10, iVar5, ((*((ushort *) (ptr_to_int(msg) + 0x16))) + 0x2d) & 0xfffffffe);
          func_037cb8b4(ptr_to_int(msg) + 0x28, iVar5 + 0x18, 6);
          func_037cb8b4(ptr_to_int(msg) + 0x2e, iVar5 + 0x1e, 6);
          puVar6 = (undefined2 *) func_037d14bc();
          *puVar6 = 0x11;
          puVar6[1] = 0;
          puVar6[2] = 0xf;
        ...
        if ((*((int *) (unaff_r8 + 6))) != 0)
      {
        ...
        func_037cb8b4(ptr_to_int(msg) + 0x10, ctx, uVar15);
        uVar7 = func_037cb520();
        uVar1 = unaff_r8[0x42];
        uVar13 = 0;
        if (uVar1 == 1)
        ...
        unaff_r8[0x42] = 1;
        unaff_r8[0x41] = *((ushort *) (ptr_to_int(ctx) + 10));
        uVar2 = *((ushort *) (((int) msg) + 0x18));
        uVar18 = (uVar2 & 0x2000) != 0;
        unaff_r8[0x48] = (ushort) uVar18;
        uVar15 = DAT_022cf74c;
        new_var = (int) ctx;
        uVar3 = ((ulonglong) uVar15) * ((longlong) u64_lo32((((((uint) (*((ushort *) (new_var + 10)))) - ((uint) (*((ushort *) (new_var + 0xc))))) & 0xffff) + 0x80) * 0x10));
        uVar4 = uVar3 >> 6;
        in_r3 = (ushort *) DAT_022cf750;
        ((void (*)(void *, ulonglong, void *, void *)) func_037cacfc)((void *) DAT_022cf748, uVar4 >> 10, (void *) ((ushort *) DAT_022cf750), 0);
        ...
        if (uVar18 != 0)
        {
          ...
          iVar5 = u64_lo32(iVar5 + (((uint) (iVar5 >> 1)) >> 0x1e)) >> 2;
          iVar5 = iVar5 - 0x20;
          if (iVar5 >= 0)
          {
            if (0x200 < iVar5)
        ...
        {
          new_var4 = (ushort *) (new_var + 6);
          func_037cb8b4(ptr_to_int(msg) + 0x28, new_var + 0x18, 6);
          func_037cb8b4(((int) msg) + 0x2e, new_var + 0x1e, 6);
          if (((uint) (*new_var4)) < 2U)
          {
            goto case182_small;
          }
          *new_var4 = (*((ushort *) (new_var + 6))) - 2;
          unaff_r8[0x2f] = (ushort) (((*((ushort *) (new_var + 0x30))) & 0x8000) != 0);
          puVar6 = (undefined2 *) func_037d14bc();
          *puVar6 = 0xe;
          puVar6[1] = 0;
          ...
          *((void **) (puVar6 + 4)) = ctx;
          func_037d1464();
          in_r3 = (ushort *) ((uint) (*new_var4));
          if (in_r3 != ((ushort *) 0x0))
          {
            FUN_022d5a64(0, (uint) (*((ushort *) (new_var + 0x30))), (ushort *) (new_var + 0x32), (uint) in_r3, ctx);
          }
          goto case182_join;
          case182_small:
      ...
      case 0x184:
      {
        ...
        volatile uint vtmp184;
        volatile uint counter184;
        unsigned int flag184;
        ...
        if (((*((ushort *) (ptr_to_int(msg) + 0x12))) != 0) || ((unaff_r8[0x33] == 1) && ((*((ushort *) (((int) msg) + 0x10))) != 0)))
        {
          FUN_022cfa90();
          break;
        }
        ...
        uVar15 = (((uint) (*((ushort *) (((int) msg) + 0x16)))) * ((uint) (*((ushort *) (ptr_to_int(msg) + 0x14))))) + 10;
        if (unaff_r8[0x39] < uVar15)
        {
          uVar15 = (uint) unaff_r8[0x39];
        }
        func_037cb8b4(ptr_to_int(msg) + 0x10, base184, uVar15);
        ctx = *((void **) (G_023190dc + 0x550));
        uVar15 = (uint) (*((ushort *) (ptr_as_int(ctx) + 0xbe)));
        if (((*base184) == 0) && ((*((ushort *) (((int) msg) + 0x14))) >= 1))
        {
          puVar9 = (ushort *) (((byte *) msg) + 0x1a);
          for (iVar5 = 0; iVar5 < u64_lo32((uint) (*((ushort *) (ptr_to_int(msg) + 0x14)))); iVar5 = iVar5 + 1)
          {
            uVar8 = FUN_022cfa7c((uint) (*((((byte *) puVar9) + (((uint) (*((ushort *) (((int) msg) + 0x16)))) * iVar5)) + 3)));
            if (uVar8 < uVar15)
            {
              uVar15 = uVar8;
            }
        ...
        zeroHi184 = zeroLo184;
        zero64184 = 0;
        for (; base184[2] > counter184; counter184 = (counter184 + 1) & 0xffff, puVar19 = (ushort *) (ptr_to_int(puVar19) + ((uint) read_stride_volatile(base184))))
        {
          ...
          if ((index184 >= 1) && (index184 <= 0xf))
          {
              ...
              if (uVar13 == 0)
            {
              ...
              uVar20 = uVar20 | shl(1, index184);
              uVar3 = *((ulonglong *) (unaff_r8 + 0x3dc));
              if ((uVar3 != zero64184) && (uVar4 != zero64184))
              {
                if (((shl((ulonglong) ((uint) iVar5), 0x20) | uVar15) - uVar4) > uVar3)
                {
                  puVar10 = FUN_022ce718();
                  *((ulonglong *) ((unaff_r8 + shl(index184, 2)) + 0x39c)) = 0;
                  if (puVar10 != ((undefined4 *) 0x0))
                  {
                    *puVar10 = 0x25;
                    ...
                    if (func_037c9e90(DAT_022cf738, puVar10, 0) != 0)
                    {
                      continue;
                    }
                  }
        ...
        *((ushort **) (puVar6 + 4)) = base184;
        ...
        iVar5 = ((*((short *) (unaff_r8 + 0x31))) > 0) && ((*((short *) (unaff_r8 + 0x32))) > 0);
        func_037cb534();
        new_var2 = (ushort *) (ptr_to_int(msg) + 0x10);
        if (iVar5 != 0)
        {
          if (flag184 == 1)
          {
            uVar15 = (uint) (*new_var2);
          }
          else
          {
            uVar15 = DAT_022cf758;
          ...
          if (unaff_r8[0x22] != 0)
          {
            ...
            in_r3 = (ushort *) DAT_022cf760;
            func_037cacfc(DAT_022cf75c, *((undefined4 *) (unaff_r8 + 0x24)), *((undefined4 *) (unaff_r8 + 0x26)), (ushort *) DAT_022cf760, uVar15);
          }
          else
          {
            FUN_022cfb24(uVar15);
      ...
      case 0x185:
        ...
        if ((*((int *) (unaff_r8 + 6))) != 0)
      {
        if ((*((ushort *) (ptr_to_int(msg) + 0xe))) == 0)
        {
          iVar16 = 1;
          uVar12 = ((volatile ushort *) DAT_022cf764)[0];
          uVar1 = ((volatile ushort *) DAT_022cf764)[1];
          uVar2 = ((volatile ushort *) DAT_022cf764)[0];
          if (uVar12 > uVar2)
          {
            uVar1 = ((volatile ushort *) DAT_022cf764)[1];
          }
          ...
          ;
          if (((short) (((ushort) uVar15) - (*((volatile ushort *) (unaff_r8 + 0x41))))) <= 0)
          {
            goto switchD_022ce940_default;
          }
        }
        ...
        else
        {
          ...
          uVar14 = 1;
          if ((in_r3 != ((ushort *) 0x0)) && ((iVar16 != 0) || ((((uint) (*((ushort *) (((int) msg) + 0x3e)))) & (1 << unaff_r8[0xc4])) == 0)))
          {
            uVar14 = 0;
          }
          if (in_r3 != ((ushort *) 0x0))
          ...
          if (uVar13 != 0)
          {
            ...
            *puVar6 = 0xe;
            if (iVar16 != 0)
            {
              ...
              if ((((uint) (*((ushort *) (ptr_to_int(msg) + 0x3e)))) & shl(1, unaff_r8[0xc4])) != 0)
            {
              new_var3 = 0xf;
              puVar6[1] = new_var3;
            }
            ...
            *((undefined4 *) (puVar6 + 4)) = 0;
            if (iVar16 == 0)
            {
              ...
              puVar6[0xf] = *((undefined2 *) (ptr_to_int(msg) + 0x3c));
            ...
            if (uVar18 != 0)
            {
              if (!((iVar5 != 1) && (unaff_r8[0x2f] != 0)))
              {
                ...
                {
                  func_037cade0(DAT_022cf75c);
                  in_r3 = (ushort *) DAT_022cfa38;
                  func_037cacfc(DAT_022cf75c, *((undefined4 *) (unaff_r8 + 0x28)), *((undefined4 *) (unaff_r8 + 0x2a)), (ushort *) DAT_022cfa38, 0);
                }
                else
                {
                  FUN_022cfc48();
      ...
      case 0x186:
        if ((unaff_r8[0x3e6] == 1) && ((*((ushort *) (((int) msg) + 0x10))) == 0x20))
      {
        uVar7 = func_037cb520();
        func_037cade0(DAT_022cf748);
        unaff_r8[0x42] = 0;
